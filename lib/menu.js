...
const template = [{
    ...
    submenu: [{
        ...
        click: () => main.getMainWin().webContents.send('exportProject')
    }, {
        label: 'Preview',
        accelerator: 'CmdOrCtrl+P',
        type: 'checkbox',
        click: (menuItem) => main.getMainWin().webContents.send('togglePreview', Boolean(menuItem.checked), configuration.get(), theme.get())
    }]
}, {
    label: 'Theme',
    submenu: [{
        label: 'None',
        type: 'radio',
        checked: Boolean(theme.get() === 'none'),
        click: changeTheme
    }, {
        label: 'Black',
        type: 'radio',
    ...
    submenu: [{
        ...
        click() {
            main.getMainWin().webContents.toggleDevTools()
        }
    }]
}];
...
function insert(content) {
    main.getMainWin().webContents.send('insert', content);
}
