...
//Localization
var _ = JSON.parse(fs.readFileSync('./lib/front/locale/it/ui.json', 'utf8'));
console.log(_)
//const gettext = require('electron-gettext');
//const _ = gettext.gettext;
//gettext.setlocale('LC_ALL', 'it');
//console.log(path.resolve('./lib/front/locale'));
//gettext.loadLanguageFile('./lib/front/locale/ui.po', 'it', ()=>{});
//gettext.loadLocaleDirectory('./lib/front/locale', () => 
//    //openFileButtonEl.innerText = _('Open file');
//    console.log(_('Open file'));
