...
const template = [{
    ...
    submenu: [{
        ...
        click: () => mainWindow.send('exportProject')
    }, {
        label: 'Preview',
    ...
    submenu: [{
        ...
        click: (menuItem) => updateConfiguration({
        ...
        submenu: [{
            label: 'Default',
            type: 'radio',
            checked: Boolean(configuration.transitionSpeed === 'default'),
            click: (menuItem) => updateConfiguration({
                transitionSpeed: 'default'
            })
        }, {
            label: 'Fast',
            type: 'radio',
            checked: Boolean(configuration.transitionSpeed === 'fast'),
            click: (menuItem) => updateConfiguration({
            ...
            label: 'Slow',
            type: 'radio',
            checked: Boolean(configuration.transitionSpeed === 'slow'),
            click: (menuItem) => updateConfiguration({
        ...
        submenu: [{
            label: 'None',
            type: 'radio',
            checked: Boolean(configuration.backgroundTransition === 'none'),
            click: (menuItem) => updateConfiguration({
            ...
            label: 'Slide',
            type: 'radio',
            checked: Boolean(configuration.backgroundTransition === 'slide'),
            click: (menuItem) => updateConfiguration({
                backgroundTransition: menuItem.label.toLowerCase()
            })
        }, {
            label: 'Fade',
            type: 'radio',
            checked: Boolean(configuration.backgroundTransition === 'fade'),
            click: (menuItem) => updateConfiguration({
                backgroundTransition: menuItem.label.toLowerCase()
            })
        }, {
            label: 'Convex',
            type: 'radio',
            checked: Boolean(configuration.backgroundTransition === 'convex'),
            click: (menuItem) => updateConfiguration({
                backgroundTransition: menuItem.label.toLowerCase()
            })
        }, {
            label: 'Concave',
            type: 'radio',
            checked: Boolean(configuration.backgroundTransition === 'concave'),
            click: (menuItem) => updateConfiguration({
                backgroundTransition: menuItem.label.toLowerCase()
            })
        }, {
            label: 'Zoom',
            type: 'radio',
            checked: Boolean(configuration.backgroundTransition === 'zoom'),
            click: (menuItem) => updateConfiguration({
                backgroundTransition: menuItem.label.toLowerCase()
            })
        }]
    ...
    submenu: [{
        ...
        type: 'checkbox',
        checked: configuration.slideNumber,
        click: (menuItem) => updateConfiguration({
...
function saveFile(content, withDependecies = false) {
    ...
    fs.readFile(templatePath, 'utf8', (err, data) => {
        ...
        const configurationToSave = JSON.stringify(Object.assign({}, configuration, {dependencies}));
        ...
        if (withDependecies) {
            //save dependecies
            fs.copy('./node_modules/reveal.js/lib', path.join(path.dirname(fileName), 'lib'), (err)=>{console.log('lib copied', err)});
            fs.copy('./node_modules/reveal.js/css', path.join(path.dirname(fileName), 'css'), (err)=>{console.log('css copied', err)});
            fs.copy('./node_modules/reveal.js/plugin', path.join(path.dirname(fileName), 'plugin'), (err)=>{console.log('plugin copied', err)});
            fs.copy('./node_modules/reveal.js/js', path.join(path.dirname(fileName), 'js'), (err)=>{console.log('js copied', err)});
        }
    });
}
