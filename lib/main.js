        ...
        submenu: [
            {
                ...
                click: (menuItem)=>updateConfiguration({transitionSpeed: 'default'})
            },{
                label: 'Fast',
                type: 'radio',
                checked: Boolean(configuration.transitionSpeed === 'fast'),
                click: (menuItem)=>updateConfiguration({transitionSpeed: 'fast'})
            },{
                label: 'Slow',
                type: 'radio',
                checked: Boolean(configuration.transitionSpeed === 'slow'),
                click: (menuItem)=>updateConfiguration({transitionSpeed: 'slow'})
            }  
        ]
    }, {
        ...
        submenu: [
            {
                ...
                click: (menuItem)=>updateConfiguration({backgroundTransition: menuItem.label.toLowerCase()})
            }, {
                label: 'Slide',
                type: 'radio',
...
function togglePreview()  {
    preview = !preview;
    mainWindow.webContents.send('togglePreview', preview, configuration, theme);
}
...
ipcMain.on('togglePreview', (event) => {
  togglePreview();
})
