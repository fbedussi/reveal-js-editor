...
function set(newConfiguration) {
    ...
    BrowserWindow.getFocusedWindow().webContents.send(event, configuration);
}

function setUiConf(newConfiguration) {
    configuration = Object.assign({}, uiConfiguration, newConfiguration);
    BrowserWindow.getFocusedWindow().webContents.send('uiConfigurationChanged', configuration);
}
