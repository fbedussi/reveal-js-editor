...
import {copyHtmlToClipboard, insert, insertImage, openSlideBgPanel, togglePreviewPanel,
	openPreviewWin, setTheme, setConfiguration, openConfPanel, setUiConf, changeLanguage, openThemesPanel} from '../actions/actions';
import {getLabel, getCurrentFileName, getCurrentTheme, getConfiguration, getUiConf, getPreviewPanelOpen} from '../selectors';
...
class Menu extends React.Component {
	...
	getTemplate() {
		...
		const colorSchemesMenuItems = this.props.uiConf.colorSchemes.map(fileName => ({
            ...
            click: (menuItem) => {this.props.setUiConf({currentColorScheme: menuItem.label})}
        }));
