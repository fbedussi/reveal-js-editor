...
const mapDispatchToProps = dispatch => ({
	...
	saveThisProject: () => dispatch(saveProject(true)),
...
class Menu extends React.Component {
	...
	getFileItems() {
		...
		var fileItems = [{
				...
				label: this.props.label('Save presentation as...'),
				click: this.props.saveProject
			}, {
				label: this.props.label('Save this presentation'),
				click: this.props.saveThisProject,
