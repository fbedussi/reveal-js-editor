...
import {getCurrentFileName, getLeftPanelStatus, getPreviewPanelOpen, getCurrentTheme, getCustomCss, getInit,
...
class App extends React.Component {
	...
	render() {
		...
		var customCss = this.props.customCss.replace(/(.[^}]+}(:?.|\n|$))/g, '.preview $1');
		...
		return (
			<div className={classes}>
				<Helmet
					...
					link={styles}
					style={[{type: "text/css", cssText: customCss}]}
				/>
				<Menu />
				<Workarea />
				<BgPanel />
