...
import {openFileRequest, saveProjectRequest} from '../actions';
...
const mapDispatchToProps = dispatch => ({
   ...
   saveProjectRequest: () => dispatch(saveProjectRequest()) 
});
   ...
   render: function() {
      return (
         ...
         <section className="controls">
            ...
            <button id="savePresentation" onClick={()=>this.props.saveProjectRequest()}>
