...
class CloseBtn extends React.Component {
	render() {
		return (
			<button className='closeBtn flatButton' onClick={this.props.clickHandler.bind(this)}>
			<svg className='closeIcon icon' xmlns="http://www.w3.org/2000/svg" width="179760.707" height="179760.522" viewBox="0 0 168.52566 168.52548">
