...
import {getLabels, getConfPanelStatus, getConfiguration} from '../selectors';
...
class ConfPanel extends React.Component {
	...
	render() {
		return (
			<Panel name='rightPanel confPanel' closePanel={this.props.closePanel}>
