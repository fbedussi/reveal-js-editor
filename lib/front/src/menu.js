...
import {getLabels, getLanguageIso, getCurrentColorScheme} from './selectors';
import {changeLanguage, openFileRequest, saveProjectRequest, saveMd, saveHtml, copyHtml, showInFolder, openInEditor, menuUpdated} from './actions';
...
function getTemplate(state) {
    ...
    const template = [{
        ...
        submenu: [{
            ...
            click: () => {store.dispatch(openFileRequest())}
        }, {
            label: _('Save presentation...'),
            accelerator: 'CmdOrCtrl+S',
            click: () => {store.dispatch(saveProjectRequest())}
        }, {
