...
import {openFileRequest} from '../actions';
...
const mapDispatchToProps = dispatch => ({
   openFileRequest: () => dispatch(openFileRequest())
});
   ...
   render: function() {
      return (
         ...
         <section className="controls">
            <button id="openFile" onClick={()=>this.props.openFileRequest()}>
                ...
                <span className="button-text text">{this.props.translations['Open markdown file']}</span>
            </button>
