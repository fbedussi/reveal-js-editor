...
const {getMediaFiles,
    ...
    replaceRelativeMediaPathWithAbsoluteInMd} = require('./pathHelpers');
...
function save(options) {
	...
	const fileName = options.fileName || dialog.showSaveDialog(BrowserWindow.getFocusedWindow(), {
    ...
    return new Promise((fullfill, reject) => {
        ...
        //save markdown
        if (md) {
            let mdWithRelativePath = replaceAbsoluteMediaPathWithRelativeInMd(md);
